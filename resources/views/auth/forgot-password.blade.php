...
<head>
    ...
    <title>Lupa Password - BookHub Sekolah</title>
...
<body class="font-sans antialiased">
    ...
    <div
        ...
        <div class="max-w-md w-full">
            <div
                class="bg-white rounded-2xl shadow-2xl p-8 lg:p-10 transform transition-all duration-300 hover:shadow-3xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Jangan khawatir, kami akan mengirimkan link reset password ke
                        email Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div>
                        <button type="submit"
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <svg class="h-5 w-5 text-indigo-300 group-hover:text-indigo-200 transition duration-200"
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-600">
                            Ingat password Anda?
                            <a href="{{ route('login') }}"
                                class="text-indigo-600 hover:text-indigo-800 font-semibold transition duration-200 inline-flex items-center gap-1">
