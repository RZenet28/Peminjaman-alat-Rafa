    ...
    <div class="password-wrapper">
        <a href="{{ route('petugas.profile') }}" class="back-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" style="margin-right: 5px;">
        ...
        <div class="glass-card">
            <form action="{{ route('petugas.update_password') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @error('current_password')
                        <span
                            style="color: #ef4444; font-size: 0.75rem; margin-top: 0.4rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="security-notice">
                ...
                <p>Pastikan password baru Anda sulit ditebak dan belum pernah digunakan sebelumnya untuk keamanan maksimal.
                </p>
            </div>
        </div>
    </div>
