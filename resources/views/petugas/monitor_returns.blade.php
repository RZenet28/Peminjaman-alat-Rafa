                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($return->tanggal_kembali < now())
                                            <span class="badge badge-danger">Terlambat
                                                ({{ $return->tanggal_kembali->format('d/m/y') }})</span>
                                        @else
                                            <span class="badge badge-info">{{ $return->tanggal_kembali->format('d M Y') }}</span>
                                        @endif
                                    </td>
                                    <td style="text-align: center;">
                                        <button onclick="openReturnModal({{ $return->id }})" class="btn btn-outline"
                                            style="padding: 0.4rem 0.8rem;">Catat Kembali</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <form id="returnForm" method="POST">
                ...
                <div style="display: flex; gap: 0.75rem;">
                    ...
                    <button type="button" onclick="closeReturnModal()" class="btn btn-outline"
